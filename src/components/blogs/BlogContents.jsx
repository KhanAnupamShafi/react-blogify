import ReactThumb from '../../assets/blogs/React-Roadmap.jpg';
    ...
    <section>
      <div className="container text-center py-8">
        ...
        <div className="mx-auto w-full md:w-10/12 text-slate-300 text-base md:text-lg leading-8 py-2 !text-left">
          ...
          name * 2 bytes per character = 60 bytes per entry Each entry is stored
          as a LinkedHashMapEntry which adds 2 references to HashMap.Node which
          itself holds 3 references and 1 int. On a 64bit VM that&apos;s 5
          references * 8 bytes, plus 4 bytes for the int: 44 bytes per entry. So
          for the entries alone we&apos;re at (60 + 44) * 1000 = 104 KB. The
          default load factor is 75%, which means the size of the array backing
          the hashmap must always be at least 25% greater than the number of
          entries. And the array size has to be a factor of 2. So, for 1000
          entries, that&apos;s an object array of size 2048: 2048 * 8 = 16,314
          bytes. The total retained size of the map is ~120 KB. Can we do
          better? Could we make it... 0?
